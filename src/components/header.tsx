    ...
    <>
      <header 
        className={`fixed top-0 left-0 w-full z-999 transition-all duration-300 ${
          isScrolled ? 'bg-black/90 py-4' : 'bg-transparent pb-12.5 pt-2'
        }`}
      >
        <div className="flex items-center justify-between px-6 lg:px-12.5 max-w-480 mx-auto">
          ...
          <div className="hidden md:flex items-center gap-4 lg:gap-6">
            <div className="header__action">
              <a  
                href="#portfolio" 
                className="inline-flex items-center justify-center px-6 py-2.5 border border-white rounded-full text-white text-[14px] font-medium transition-all duration-300 hover:bg-white hover:text-black group"
              >
                Our Portfolio 
